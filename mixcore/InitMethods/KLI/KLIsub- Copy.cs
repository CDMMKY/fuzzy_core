...
namespace KLI
{
    public class KLIsub : AbstractNotSafeGenerator
    {
        ...
        {
            return with_param ? @"КЛИsub: Функции принадлежности= " + Term.ToStringTypeTerm(type_func) + Environment.NewLine : "КЛИsub";
        }
