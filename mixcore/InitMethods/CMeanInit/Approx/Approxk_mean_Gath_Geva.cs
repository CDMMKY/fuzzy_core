...
{
    class Approxk_mean_Gath_Geva : Approxk_mean_base
    {

        public Approxk_mean_Gath_Geva(SampleSet Learn_table, int Max_iter, double precision_needed, int needed_count_clusters, double nebula)
