...
{
    class Classifierk_mean_Gustafson_kessel:Classifierk_mean_base
    {
        List<List<double>> fuzzy_covariance_Matrix_F = new List<List<double>>();
        public Classifierk_mean_Gustafson_kessel (SampleSet Learn_table,int Max_iter, double precision_needed, int needed_count_clusters,double nebula)
