...
{
    class TakagiSugenoApproximate_FrontEnd : Singletone_FrontEnd
    {


        MethodLoadTakagiSugenoApproximateHelper AllMethods;
        string UFS_file_name = "";

        #region IFuzzy_System_FroentEnd implementation

        public TakagiSugenoApproximate_FrontEnd()
        {
            AllMethods = new MethodLoadTakagiSugenoApproximateHelper();
        }
        ...
        public override void Set_count_add_generator(int count_used_Algorithm)
        {
        ...
        public override void Set_count_learn_algorithm(int count_used_Algorithm)
        {
    ...
    public override IGeneratorConf Set_add_generator_algorothm(int numAlgorithm, int typeAlgorithm)
        {
        ...
        public override ILearnAlgorithmConf Set_learn_algorothm(int numAlgorithm, int typeAlgorithm)
        {
        ...
        public override void Set_count_repeate_into_cirlucle(int numRepeate) { Repeat_into = numRepeate; }

        public override void Set_count_repeate_renew(int numRepeate) { Repeat_renew_global = numRepeate; }

        public override string get_log { get { return LOG; } }

        public override bool Is_UFS { get { return is_UFS; } }

        public override int get_global_completed() { return Repeat_renew_global; }
        ...
        public override bool is_autosave_FS { set { is_autosave = value; } }

        public override string path_to_save { set { path = value; } }

        public override int max_sections_of_Calc
        {
            get
            {
                int learn_count = 0;
        ...
        public override System.ComponentModel.BackgroundWorker ProgressSource { set { progressSource = value; } }
        ...
        public override string[] add_generator_for_Singleton()
        {
        ...
        public override object[] addGeneratorAlgorithm
        {
            get
            {
        ...
        protected override List<int> prepare_generate_to_Calc()
        {
        ...
        public override string[] learn_algorithm_for_Singletone()
        {
            List<string> result = new List<string>();
        ...
        public override object[] learn_algorithm
        {
            get
            {
        ...
        protected override List<int> prepare_learn_to_Calc()
        {
        ...
        protected override int Make_inform_back_process(int current_state, int max_state)
        {
            current_state++;
        ...
        bool is_UFS = false;
        TSAFuzzySystem Approx_Singletone = null;
