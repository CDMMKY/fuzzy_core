...
namespace FuzzySystem.SingletoneApproximate.Mesure
{
    ...
    {
        public static double getNormalIndex(this SAFuzzySystem source, double goodsForBorder = 0, double goodsForAreas = 0, int indexDataBase = 0)
        {
            double result = 0.0;
            if (goodsForBorder == 0.0)
            {
                goodsForBorder = FuzzyCore.Properties.Settings.Default.Pareto_simpler_UnionTerms_byBorderPercent * 0.01;
            }
            if (goodsForAreas == 0.0)
            {
        ...
        public static double getGIBNormal(this SAFuzzySystem source, double goodsForBorder = 0, int indexDataBase = 0)
        {
            double result = 0.0;
            if (goodsForBorder == 0)
            {
        ...
        public static double getGIBSumStrait(this SAFuzzySystem source, double goodsForBorder = 0, int indexDataBase = 0)
        {
            double result = 0.0;
            if (goodsForBorder == 0)
            {
        ...
        public static double getGIBSumReverse(this SAFuzzySystem source, double goodsForBorder = 0, int indexDataBase = 0)
        {
            double result = 0.0;
            if (goodsForBorder == 0)
            {
        ...
        public static double getGISNormal(this SAFuzzySystem source, double goodsForArea = 0, int indexDataBase = 0)
        {
            double result = 0.0;
            if (goodsForArea == 0)
            {
        ...
        public static double getGISSumStraigt(this SAFuzzySystem source, double goodsForArea = 0, int indexDataBase = 0)
        {
            double result = 0.0;
            if (goodsForArea == 0)
            {
        ...
        public static double getGICNormal(this SAFuzzySystem source, int indexDataBase = 0)
        {
            double result = 0.0;
            if (source != null)
            {
        ...
        public static double getGICSumStraigth(this SAFuzzySystem source, int indexDataBase = 0)
        {
            double result = 0.0;
        ...
        public static double getLindisNormal(this SAFuzzySystem source, int indexDataBase = 0)
        {
            double result = 0.0;
            if (source != null)
            {
        ...
        public static double getLindisSumStraight(this SAFuzzySystem source, int indexDataBase = 0)
        {
            double result = 0.0;
            if (source != null)
            {
        ...
        public static double getIndexSumStraigt(this SAFuzzySystem source, double goodsForBorder = 0, double goodsForAreas = 0, int indexDataBase = 0)
        {
            double result = 0.0;
            if (goodsForBorder == 0)
            {
        ...
        public static double getIndexReal(this SAFuzzySystem source, double goodsForBorder = 0, double goodsForAreas = 0, int indexDataBase = 0)
        {
            double result = 0.0;
            if (goodsForBorder == 0)
            {
