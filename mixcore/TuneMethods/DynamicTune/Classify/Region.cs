...
namespace DynamicTunePC
{
    ...
    public class Region
    {
        ...
        private List<bool> GetRules(KnowlegeBasePCRules knowlegeBase)
        {
        ...
        public void GetLimits(PCFuzzySystem approx)
        {
