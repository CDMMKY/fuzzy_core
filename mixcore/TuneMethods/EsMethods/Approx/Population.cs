   ...
   public class Population
    {
       ...
       public  List<Individ> ThePopulate { get { return the_popualate; } }
        int size_populate;
        int size_child;
        ...
        public void init_first(KnowlegeBaseSARules base_rule, Random rand, FuzzySystem.FuzzyAbstract.learn_algorithm.conf.ESConfig.Type_init prm_init)
        { 
            bool the_first=true ;
        ...
        public KnowlegeBaseSARules get_best_database()
        {
