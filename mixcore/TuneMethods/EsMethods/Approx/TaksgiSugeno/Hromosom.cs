...
namespace FuzzySystem.TakagiSugenoApproximate.LearnAlgorithm.ES
{
    public class Hromosom
    {
        KnowlegeBaseTSARules core_check;
        public KnowlegeBaseTSARules Core_Check { get { return core_check; } }
        List<Term> Fenotip_terms;
        List<double> Fenotip_kons;

        public Hromosom(KnowlegeBaseTSARules Source)
        {
            core_check = Source;
