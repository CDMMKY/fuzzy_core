...
namespace FuzzySystem.PittsburghClassifier.LearnAlgorithm.ES
{
    ...
    {
        KnowlegeBasePCRules core_check;
        public KnowlegeBasePCRules Core_Check { get { return core_check; } }
        List<Term> Fenotip_terms;
        List<double> Fenotip_kons;

        public Hromosom(KnowlegeBasePCRules Source)
        {
            core_check = Source;
            Fenotip_kons = core_check.Weigths.ToList();
        ...
        {
            core_check = new KnowlegeBasePCRules(the_Source.core_check);
            Fenotip_kons = core_check.Weigths.ToList();
            Fenotip_terms = core_check.TermsSet.ToList();
        ...
        public void init_random(Random rand, SampleSet Data)
        {
            ...
            {
                Fenotip_kons[j] =  rand.NextDouble();
            }
