...
namespace GeneticAlgorithmTune
{
    ...
    public delegate KnowlegeBaseSARules crossoverFuncType(KnowlegeBaseSARules parent1, KnowlegeBaseSARules parent2);
    ...
    public class GeneticApprox : AbstractNotSafeLearnAlgorithm
    {
     ...
     protected KnowlegeBaseSARules[] populationMassive;
     protected KnowlegeBaseSARules[] childrenMassive;
     protected SAFuzzySystem fullFuzzySystem;
     protected SAFuzzySystem result;
        int step = 0;
        double errorAfter;
        double errorBefore;
        KnowlegeBaseSARules backUp;
        #endregion
        ...
        KnowlegeBaseSARules pointsCrossover(KnowlegeBaseSARules parent1, KnowlegeBaseSARules parent2)
        {
            KnowlegeBaseSARules child = new KnowlegeBaseSARules(parent1);
        ...
        public void fullCrossover()
        {
            ...
            for (int i = 0; i < currentConf.GENCCountChild; i++)
            {
                ...
                childrenMassive[i] = new KnowlegeBaseSARules(crossoverFunc(populationMassive[a], populationMassive[b]));
            }
            //});
        ...
        public int findMinErrorElement()
        {
            ...
            {
                if (error > fullFuzzySystem.approxLearnSamples(fullFuzzySystem.RulesDatabaseSet [i]))
                {
                    step = i;
                    error = fullFuzzySystem.approxLearnSamples(fullFuzzySystem.RulesDatabaseSet [ i]);
                }
            }
            //});
            return step;
