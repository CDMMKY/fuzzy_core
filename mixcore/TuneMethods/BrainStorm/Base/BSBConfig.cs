...
namespace FuzzySystem.FuzzyAbstract.learn_algorithm.conf
{
    ...
    public class BSBConfig : ILearnAlgorithmConf
    {
        [DisplayName("Количество итераций"), Category("Основные параметры")]
        public int iter
        {
            get { return Settings.Default.iter; }
            set { Settings.Default.iter = value; Settings.Default.Save(); }
        }
        [DisplayName("Количество популяций"), Category("Основные параметры")]
