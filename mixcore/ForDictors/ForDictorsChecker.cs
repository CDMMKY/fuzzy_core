...
{
    public class ForDictorsChecker : AbstractNotSafeLearnAlgorithm
    {
        ...
        public override string ToString(bool with_param = false)// без параметров возвращает имя алгоритма, с параметров true возвращает имя алгоритма и значения его параметров
        {
            if (with_param)
            {
                string result = "Не использовать так как не стабильно{";
            ...
            return "Не использовать так как не стабильно";
        }
